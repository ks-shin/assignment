...
async function getResult() {             //2.getResult() 함수의 실행 
    ...
    return Promise.all(_.map(list, async (keyword) => { //list 배열안의 있는 객체 하나를 keyword 변수에 넣어서 keyword 변수를 가지고 해당된 arrow 함수를 실행한다.
        console.log("1",keyword.rank)
...
//await 는 promise를받아서 resolve 될때까지 기다린다